	...
	<section>
		<div style="width: 1200px; height: 780px; margin: 0 auto;margin-top: 0px; " >
			...
			<table id="room" class="btn draw-border">
				<tr>
					...
					<td colspan="3"><input type="text" size="25" style="height: 25px;" ></td>
				...
				<tr>
					...
					<td ><input type="number" name="id" min="1" max="10" style="width: 100px;" /></td>
						<tr>
    	...
    	<td class="room_name">지역</td>
			...
			<td class="room_name">성별</td>
					<td><input type="radio" name="gender" value="man" style=" background-color: red" required >남성 <input
			...
			<div class="three">
				<div class="window">
					<input type="button" value="등록" class="custom-btn-1 btn-1" /> <input
